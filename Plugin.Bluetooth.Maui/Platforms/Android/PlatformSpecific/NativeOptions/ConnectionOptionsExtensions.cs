...
{
    public static BluetoothGatt? ConnectGatt(this Android.Bluetooth.BluetoothDevice nativeDevice, ConnectionOptions? connectionOptions, BluetoothGattCallback? bluetoothGattCallback)
    {
