...
/// <summary>
///     Main application class for the Bluetooth Broadcaster sample.
/// </summary>
public partial class App : Application
{
    ...
    {
        var broadcasterPage = _serviceProvider.GetRequiredService<BroadcasterDemoPage>();
        var navigationPage = new NavigationPage(broadcasterPage);
