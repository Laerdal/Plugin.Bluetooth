...
public class BluetoothBroadcaster : IBluetoothBroadcaster
{
...
#else
    private readonly Bluetooth.Maui.Platforms.DotNetCore.Broadcasting.DotNetCoreBluetoothBroadcaster _platformBroadcaster;
#endif
        ...
        ILoggerFactory? loggerFactory = null)
    {
        ...
        _platformBroadcaster = new Bluetooth.Maui.Platforms.Apple.Broadcasting.AppleBluetoothBroadcaster(
            ...
            loggerFactory);
#elif WINDOWS
        _platformBroadcaster = new Bluetooth.Maui.Platforms.Win.Broadcasting.WindowsBluetoothBroadcaster(
            adapter,
            ticker,
            loggerFactory);
#else
        _platformBroadcaster = new Bluetooth.Maui.Platforms.DotNetCore.Broadcasting.DotNetCoreBluetoothBroadcaster(
            adapter,
            ticker,
            loggerFactory);
#endif
