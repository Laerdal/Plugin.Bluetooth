...
public class BluetoothScanner : IBluetoothScanner, IAsyncDisposable
{
...
#else
    private readonly Bluetooth.Maui.Platforms.DotNetCore.Scanning.DotNetCoreBluetoothScanner _platformScanner;
#endif
        ...
        ILoggerFactory? loggerFactory = null)
    {
        ...
        _platformScanner = new Bluetooth.Maui.Platforms.Apple.Scanning.AppleBluetoothScanner(
            ...
            loggerFactory);
#elif WINDOWS
        _platformScanner = new Bluetooth.Maui.Platforms.Win.Scanning.WindowsBluetoothScanner(
            adapter,
            rssiToSignalStrengthConverter,
            ticker,
            deviceFactory,
            ...
            loggerFactory);
#else
        _platformScanner = new Bluetooth.Maui.Platforms.DotNetCore.Scanning.DotNetCoreBluetoothScanner(
            adapter,
            rssiToSignalStrengthConverter,
            ticker,
            nameProvider,
