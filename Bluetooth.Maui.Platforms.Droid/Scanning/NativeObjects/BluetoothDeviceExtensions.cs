...
public static class BluetoothDeviceExtensions
{
    ...
    public static BluetoothGatt? ConnectGatt(this BluetoothDevice nativeDevice, ConnectionOptions? connectionOptions, BluetoothGattCallback? bluetoothGattCallback)
    {
