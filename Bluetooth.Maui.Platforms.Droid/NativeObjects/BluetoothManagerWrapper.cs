...
{
    private Android.Bluetooth.BluetoothManager? _bluetoothManager;
    ...
    public Android.Bluetooth.BluetoothManager BluetoothManager
    {
        get
        {
            ...
            {
                _bluetoothManager = Android.App.Application.Context.GetSystemService(Android.Content.Context.BluetoothService) as Android.Bluetooth.BluetoothManager;
                if (_bluetoothManager == null)
                {
