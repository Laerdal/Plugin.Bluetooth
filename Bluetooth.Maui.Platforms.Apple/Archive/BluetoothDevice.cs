...
public partial class BluetoothDevice : BaseBluetoothDevice, CbPeripheralWrapper.ICbPeripheralDelegate, CbCentralManagerWrapper.ICbPeripheralDelegate
{
    ...
    /// </summary>
    public CbPeripheralWrapper CbPeripheralDelegateWrapper { get; }
    ...
    /// <param name="cbPeripheralDelegateWrapper">The iOS Core Bluetooth peripheral delegate proxy.</param>
    public BluetoothDevice(IBluetoothScanner scanner, string id, Manufacturer manufacturer, CbPeripheralWrapper cbPeripheralDelegateWrapper) : base(scanner, id, manufacturer)
    {
        CbPeripheralDelegateWrapper = cbPeripheralDelegateWrapper;
    }
    ...
    public BluetoothDevice(IBluetoothScanner scanner, BluetoothAdvertisement advertisement) : base(scanner, advertisement)
    {
        ...
        CbPeripheralDelegateWrapper = new CbPeripheralWrapper(this, advertisement.Peripheral);
    }

    #region CbPeripheralManager.ICbPeripheralDelegate
    ...
    {
        if (CbPeripheralDelegateWrapper.CbPeripheral.Name != null)
        {
            CachedName = CbPeripheralDelegateWrapper.CbPeripheral.Name;
        }
    }
