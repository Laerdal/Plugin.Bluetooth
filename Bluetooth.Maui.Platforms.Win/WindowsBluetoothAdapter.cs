...
/// </summary>
public partial class WindowsBluetoothAdapter : BaseBluetoothAdapter
{
    /// <summary>
    ...
    /// <summary>
    ///    Initializes a new instance of the <see cref="WindowsBluetoothAdapter" /> class with the specified Bluetooth adapter and radio wrappers.
    /// </summary>
    public WindowsBluetoothAdapter(IBluetoothAdapterWrapper bluetoothAdapterWrapper, IRadioWrapper radioWrapper, ILogger<IBluetoothAdapter>? logger = null) : base(logger)
    {
