namespace Bluetooth.Maui.Platforms.Win.Logging;

/// <summary>
///     High-performance logging messages for Windows Bluetooth operations using LoggerMessage source generation.
/// </summary>
/// <remarks>
...
/// </remarks>
internal static partial class WindowsBluetoothLoggerMessages
{
    ...
    [LoggerMessage(
        EventId = 1008,
        Level = LogLevel.Information,
        Message = "BluetoothLEAdvertisementWatcher status changed to: {Status}")]
    public static partial void LogWatcherStatusChanged(
        this ILogger logger,
        string status);
    ...
    [LoggerMessage(
        EventId = 2006,
        Level = LogLevel.Error,
        Message = "Connection status change error for device {DeviceAddress}: {ErrorMessage}")]
    public static partial void LogConnectionStatusError(
        this ILogger logger,
        string deviceAddress,
        string errorMessage,
        Exception? exception);
    ...
    [LoggerMessage(
        EventId = 2007,
        Level = LogLevel.Information,
        Message = "Device {DeviceAddress} connection status changed to: {Status}")]
