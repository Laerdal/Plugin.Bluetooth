...
public abstract partial class BaseBluetoothCharacteristic : BaseBindableObject, IBluetoothCharacteristic
{
    ...
    protected BaseBluetoothCharacteristic(IBluetoothService service, IBluetoothCharacteristicFactory.BluetoothCharacteristicFactoryRequest request)
    {
        ...
        Id = AccessService.CharacteristicId;
