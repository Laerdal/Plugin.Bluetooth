...
public abstract partial class BaseBluetoothRemoteService
{
    ...
    [LoggerMessage(EventId = 300, Level = LogLevel.Information,
        Message = "Service {Id} on device {DeviceId} exploring characteristics")]
    ...
    [LoggerMessage(EventId = 301, Level = LogLevel.Information,
        Message = "Service {Id} on device {DeviceId} characteristic exploration succeeded - {CharacteristicCount} characteristics found")]
    ...
    [LoggerMessage(EventId = 302, Level = LogLevel.Error,
        Message = "Service {Id} on device {DeviceId} characteristic exploration failed")]
    ...
    [LoggerMessage(EventId = 303, Level = LogLevel.Warning,
        Message = "Service {Id} on device {DeviceId} characteristic exploration - unexpected completion without pending operation")]
    ...
    [LoggerMessage(EventId = 304, Level = LogLevel.Debug,
        Message = "Service {Id} on device {DeviceId} merging concurrent characteristic exploration attempts")]
    ...
    [LoggerMessage(EventId = 305, Level = LogLevel.Debug,
        Message = "Service {Id} on device {DeviceId} using cached characteristics - {CharacteristicCount} characteristics available")]
    ...
    [LoggerMessage(EventId = 306, Level = LogLevel.Debug,
        Message = "Service {Id} on device {DeviceId} cascading exploration to {CharacteristicCount} characteristics")]
    ...
    [LoggerMessage(EventId = 307, Level = LogLevel.Debug,
        Message = "Service {Id} on device {DeviceId} cleared {CharacteristicCount} characteristics")]
