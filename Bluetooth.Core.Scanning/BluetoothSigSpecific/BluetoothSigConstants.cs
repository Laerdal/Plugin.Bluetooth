namespace Bluetooth.Core.Scanning.BluetoothSigSpecific;
...
public static class BluetoothSigConstants
{
    ...
    public readonly static string StandardGuidExtension = "-0000-1000-8000-00805f9b34fb".ToUpperInvariant();
}
