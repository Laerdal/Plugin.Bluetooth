...
public partial class BluetoothDevice
{
    ...
    /// <inheritdoc/>
    /// <remarks>
    /// On Windows, this establishes a connection by creating a <c>BluetoothLeDeviceProxy</c> and <c>GattSessionWrapper</c>,
    ...
    protected async override ValueTask NativeConnectAsync(IBluetoothDeviceConnectionOptions connectionOptions, TimeSpan? timeout = null, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            GattSessionProxy = await PlatformSpecific.GattSessionWrapper.GetInstanceAsync(BluetoothLeDeviceProxy.BluetoothLeDevice, this, cancellationToken).ConfigureAwait(false);
