...
public class BluetoothService : BaseBluetoothRemoteService, GattDeviceServiceProxy.IBluetoothServiceProxyDelegate
{
        ...
        : base(device, request, characteristicFactory)
    {
        ...
        if (request is not BluetoothServiceFactoryRequest windowsRequest)
        {
            throw new ArgumentException(
                $"Expected request of type {typeof(BluetoothServiceFactoryRequest)}, but got {request.GetType()}");
        }
    ...
    {
        var characteristicRequest = new BluetoothCharacteristicFactoryRequest(nativeCharacteristic);
