...
/// <inheritdoc/>
public class BluetoothBroadcaster : BaseBluetoothBroadcaster, BluetoothGattServerCallbackProxy.IBroadcaster, AdvertiseCallbackProxy.IBroadcaster, IAsyncDisposable
{
    ...
    public BluetoothGattServerCallbackProxy.IDevice GetDevice(Android.Bluetooth.BluetoothDevice? nativeDevice)
    {
        ...
        {
            throw new InvalidOperationException("ClientDevice is not Android BluetoothBroadcastClientDevice");
        }
        return droidDevice;
    }
