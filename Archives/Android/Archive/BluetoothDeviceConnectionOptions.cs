...
public record BluetoothDeviceConnectionOptions : BaseBluetoothDeviceConnectionOptions
{
    ...
    /// <summary>
    /// Preferred transport for GATT connections to remote dual-mode devices <see cref="Permissions.Bluetooth.BluetoothTransports.Auto"/> or <see cref="Permissions.Bluetooth.BluetoothTransports.Bredr"/> or <see cref="Permissions.Bluetooth.BluetoothTransports.Le"/>
    /// </summary>
