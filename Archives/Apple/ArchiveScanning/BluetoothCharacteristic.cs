...
public partial class BluetoothCharacteristic : BaseBluetoothCharacteristic, CbPeripheralWrapper.ICbCharacteristicDelegate
{
    ...
    /// <inheritdoc/>
    public BluetoothCharacteristic(IBluetoothService service, IBluetoothCharacteristicFactory.BluetoothCharacteristicFactoryRequest request, IBluetoothDescriptorFactory descriptorFactory) : base(service, request)
    {
