...
public partial class BluetoothScanner : BaseBluetoothScanner, CbCentralManagerWrapper.ICbCentralManagerProxyDelegate
{
    ...
    protected async override ValueTask NativeStartAsync(IBluetoothScanner.IBluetoothScannerScanningOptions scanningOptions, TimeSpan? timeout = null, CancellationToken cancellationToken = default)
    {
    ...
    protected override ValueTask NativeStartAsync(IBluetoothScanner.IBluetoothScannerScanningOptions scanningOptions, TimeSpan? timeout = null, CancellationToken cancellationToken = default)
    {
