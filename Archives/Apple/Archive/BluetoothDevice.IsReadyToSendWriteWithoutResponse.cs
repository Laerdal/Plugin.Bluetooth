...
public partial class BluetoothDevice
{
    ...
    {
        return CbPeripheralDelegateWrapper.CbPeripheral.CanSendWriteWithoutResponse ? Task.CompletedTask : Task.Run(() => ReadyToSendWriteWithoutResponse.WaitOne(timeout), cancellationToken);
    }
}
