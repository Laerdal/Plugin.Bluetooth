...
/// </summary>
public record BluetoothScannerStartScanningOptionsWithPeripheralUuids : BluetoothScannerStartScanningOptions
{
    /// <summary>
    ...
    /// </remarks>
    public IReadOnlyList<CBUUID> PeripheralScanningPeripheralUuids { get; init; } = [];
}
