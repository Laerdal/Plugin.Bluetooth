...
public class CharacteristicWriteRequestEventArgs : System.EventArgs
{
    ...
    public CharacteristicWriteRequestEventArgs(string clientId, Guid serviceId, Guid characteristicId, ReadOnlyMemory<byte> value, int offset = 0, bool withResponse = true)
    {
        ClientId = clientId;
        ServiceId = serviceId;
