...
namespace Bluetooth.Abstractions.AccessService;
...
public interface IBluetoothCharacteristicAccessService<TRead, TWrite> : IBluetoothCharacteristicAccessService
{
    /// <summary>
    ...
    Task<TRead> ReadAsync(IBluetoothDevice device, bool useLastValueIfPreviouslyRead = false, TimeSpan? timeout = null, CancellationToken cancellationToken = default);
    ...
    Task WriteAsync(IBluetoothDevice device,
        TWrite value,
